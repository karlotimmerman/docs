...
\<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" style="background: linear-gradient(to bottom, #232370, #000033);" role="img" aria-labelledby="title desc"\>

  \<title id="title"\>Skydust Logo\</title\>

  \<desc id="desc"\>sky dust logo. one stop platform for all your CSRD needs.\</desc\>

  \<rect x="0" y="0" width="64" height="64" rx="3" ry="3" fill="url(#bg-gradient)"/\>
  ...
  \<g transform="scale(0.102) translate(1.6, 1.6)"\>
