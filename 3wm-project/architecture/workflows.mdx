---
title: "Systeem Workflows"
description: "Gedetailleerde technische workflows van het 3WM systeem"
icon: "diagram-project"
---

## Complete Systeem Workflow

Het 3WM systeem bestaat uit meerdere geïntegreerde workflows die naadloos samenwerken om documenten te verwerken van upload tot boeking.
...
De kern van het systeem - verwerkt alle binnenkomende documenten:
- **INS Naamgeving**: Unieke identificatie met timestamp
- **Multi-format Support**: PDF, JPG, PNG, TIFF
- **OCR Pipeline**: DocTR als primaire engine, TrOCR als fallback
- **Type Detection**: Automatische herkenning van facturen, ID-kaarten, certificaten

### Invoice Processing
Gespecialiseerde verwerking voor facturen:
- **Line Item Extraction**: Detectie van individuele factuurregels
- **VAT Validation**: Automatische BTW-verificatie
- **Journal Prediction**: ML-gebaseerde voorspelling van boekingen
- **Fraud Detection**: Real-time risico analyse

### AI Agent (LangGraph)
Natuurlijke taal interface voor complexe queries:
- **Intent Recognition**: Begrijpt gebruikersvragen
- **Tool Selection**: Kiest automatisch de juiste tools
- **Multi-tool Execution**: Combineert meerdere databronnen
- **Streaming Responses**: Real-time antwoorden

### Neo4j Graph Operations
Relatie-gebaseerde analyse:
- **Vendor Networks**: Leverancier relatie mapping
- **Risk Scoring**: Multi-factor risico berekening
- **Pattern Detection**: Anomalie detectie
- **Fraud Signals**: 4 typen fraude indicatoren

### Infrastructure
Ondersteunende services:
- **Rate Limiting**: Bescherming tegen overbelasting
- **Auth Middleware**: JWT token verificatie
- **Prometheus Metrics**: Performance monitoring
- **Structured Logging**: JSON-gebaseerde logs 